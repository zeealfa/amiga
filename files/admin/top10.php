...
$result = mysqli_query($myConnection, "SELECT * FROM t_top10 ORDER BY top10_order ASC");
$entries = [];
...
<html>
<head>
<title>AmigaSource.com - Manage Top 10+8</title>
				...
				<table width="100%" cellpadding="1" cellspacing="1" class="bg-white" bgcolor="<?php echo bg_hex('white'); ?>">
					<tr>
						<td align="center" class="bg-red" bgcolor="<?php echo bg_hex('red'); ?>">
							<font class="txt-4-white" face="Verdana, sans-serif" size="4" color="<?php echo txt_hex('white'); ?>"><b>MANAGE TOP 10+8</b></font>
						</td>
					</tr>
<?php if ($flash): ?>
					<tr>
...
<?php endif; ?>
					<tr>
						<td class="bg-whitesmoke" bgcolor="<?php echo bg_hex('whitesmoke'); ?>" style="padding:8px;">
							<a href="top10_form.php" class="bg-green" style="color:#ffffff; font-weight:bold; padding:4px 10px; text-decoration:none;">+ Add Entry</a>
						</td>
					</tr>
					<tr>
						<td class="bg-white" bgcolor="<?php echo bg_hex('white'); ?>" style="padding:8px;">
							<table width="100%" cellpadding="4" cellspacing="0">
								<tr class="bg-gray" bgcolor="<?php echo bg_hex('gray'); ?>">
									<td><font class="txt-2-black" face="Verdana, sans-serif" size="2" color="<?php echo txt_hex('black'); ?>"><b>Order</b></font></td>
...
<?php $is_divider = $entry['top10_name'] === '<hr>'; ?>
								<tr>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo (int) $entry['top10_order']; ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo $is_divider ? '<i>&mdash; divider &mdash;</i>' : htmlspecialchars($entry['top10_name']); ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo $is_divider ? '' : htmlspecialchars($entry['top10_url']); ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1">
										<a href="top10_form.php?id=<?php echo (int) $entry['id']; ?>">Edit</a> |
										<a href="top10_delete.php?id=<?php echo (int) $entry['id']; ?>">Delete</a>
									</font></td>
								</tr>
<?php endforeach; ?>
							</table>
