...
$result = mysqli_query($myConnection, "SELECT * FROM t_mags_online ORDER BY online_name ASC");
$mags = [];
...
<html>
<head>
<title>AmigaSource.com - Manage Online Publications</title>
				...
				<table width="100%" cellpadding="1" cellspacing="1" class="bg-white" bgcolor="<?php echo bg_hex('white'); ?>">
					<tr>
						<td align="center" class="bg-red" bgcolor="<?php echo bg_hex('red'); ?>">
							<font class="txt-4-white" face="Verdana, sans-serif" size="4" color="<?php echo txt_hex('white'); ?>"><b>MANAGE ONLINE PUBLICATIONS</b></font>
						</td>
					</tr>
<?php if ($flash): ?>
					<tr>
...
<?php endif; ?>
					<tr>
						<td class="bg-whitesmoke" bgcolor="<?php echo bg_hex('whitesmoke'); ?>" style="padding:8px;">
							<a href="mags_online_form.php" class="bg-green" style="color:#ffffff; font-weight:bold; padding:4px 10px; text-decoration:none;">+ Add Publication</a>
						</td>
					</tr>
					<tr>
						<td class="bg-white" bgcolor="<?php echo bg_hex('white'); ?>" style="padding:8px;">
							<table width="100%" cellpadding="4" cellspacing="0">
								<tr class="bg-gray" bgcolor="<?php echo bg_hex('gray'); ?>">
									...
									<td><font class="txt-2-black" face="Verdana, sans-serif" size="2" color="<?php echo txt_hex('black'); ?>"><b>Issue #</b></font></td>
...
<?php if (empty($mags)): ?>
								<tr><td colspan="4"><font class="txt-2-black" face="Verdana, sans-serif" size="2" color="<?php echo txt_hex('black'); ?>">No publications found.</font></td></tr>
<?php endif; ?>
<?php foreach ($mags as $mag): ?>
								<tr>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo htmlspecialchars($mag['online_name']); ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo (int) $mag['online_issue']; ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo htmlspecialchars($mag['online_url']); ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1">
										<a href="mags_online_form.php?id=<?php echo (int) $mag['id']; ?>">Edit</a> |
										<a href="mags_online_delete.php?id=<?php echo (int) $mag['id']; ?>">Delete</a>
									</font></td>
								</tr>
<?php endforeach; ?>
							</table>
