...
$result = mysqli_query($myConnection, "SELECT * FROM t_cfund ORDER BY cfund_date_end DESC");
$campaigns = [];
...
<html>
<head>
<title>AmigaSource.com - Manage Crowdfunding</title>
				...
				<table width="100%" cellpadding="1" cellspacing="1" class="bg-white" bgcolor="<?php echo bg_hex('white'); ?>">
					<tr>
						<td align="center" class="bg-red" bgcolor="<?php echo bg_hex('red'); ?>">
							<font class="txt-4-white" face="Verdana, sans-serif" size="4" color="<?php echo txt_hex('white'); ?>"><b>MANAGE CROWDFUNDING</b></font>
						</td>
					</tr>
<?php if ($flash): ?>
					<tr>
...
<?php endif; ?>
					<tr>
						<td class="bg-whitesmoke" bgcolor="<?php echo bg_hex('whitesmoke'); ?>" style="padding:8px;">
							<a href="crowdfunding_form.php" class="bg-green" style="color:#ffffff; font-weight:bold; padding:4px 10px; text-decoration:none;">+ Add Campaign</a>
						</td>
					</tr>
					<tr>
						<td class="bg-white" bgcolor="<?php echo bg_hex('white'); ?>" style="padding:8px;">
							<table width="100%" cellpadding="4" cellspacing="0">
								<tr class="bg-gray" bgcolor="<?php echo bg_hex('gray'); ?>">
									...
									<td><font class="txt-2-black" face="Verdana, sans-serif" size="2" color="<?php echo txt_hex('black'); ?>"><b>End Date</b></font></td>
...
<?php if (empty($campaigns)): ?>
								<tr><td colspan="4"><font class="txt-2-black" face="Verdana, sans-serif" size="2" color="<?php echo txt_hex('black'); ?>">No crowdfunding campaigns found.</font></td></tr>
<?php endif; ?>
<?php foreach ($campaigns as $campaign): ?>
								<tr>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo htmlspecialchars($campaign['cfund_name']); ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo htmlspecialchars($campaign['cfund_date_end']); ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo $campaign['cfund_active'] ? 'Yes' : 'No'; ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1">
										<a href="crowdfunding_form.php?id=<?php echo (int) $campaign['id']; ?>">Edit</a> |
										<a href="crowdfunding_delete.php?id=<?php echo (int) $campaign['id']; ?>">Delete</a>
									</font></td>
								</tr>
<?php endforeach; ?>
							</table>
