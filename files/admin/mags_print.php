...
$result = mysqli_query($myConnection, "SELECT * FROM t_mags_print ORDER BY print_name ASC");
$mags = [];
...
<html>
<head>
<title>AmigaSource.com - Manage Print Publications</title>
				...
				<table width="100%" cellpadding="1" cellspacing="1" class="bg-white" bgcolor="<?php echo bg_hex('white'); ?>">
					<tr>
						<td align="center" class="bg-red" bgcolor="<?php echo bg_hex('red'); ?>">
							<font class="txt-4-white" face="Verdana, sans-serif" size="4" color="<?php echo txt_hex('white'); ?>"><b>MANAGE PRINT PUBLICATIONS</b></font>
						</td>
					</tr>
<?php if ($flash): ?>
					<tr>
...
<?php endif; ?>
					<tr>
						<td class="bg-whitesmoke" bgcolor="<?php echo bg_hex('whitesmoke'); ?>" style="padding:8px;">
							<a href="mags_print_form.php" class="bg-green" style="color:#ffffff; font-weight:bold; padding:4px 10px; text-decoration:none;">+ Add Publication</a>
						</td>
					</tr>
					<tr>
...
<?php foreach ($mags as $mag): ?>
								<tr>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo htmlspecialchars($mag['print_name']); ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo (int) $mag['print_issue']; ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1"><?php echo htmlspecialchars($mag['print_url']); ?></font></td>
									<td><font class="txt-1" face="Verdana, sans-serif" size="1">
										<a href="mags_print_form.php?id=<?php echo (int) $mag['id']; ?>">Edit</a> |
										<a href="mags_print_delete.php?id=<?php echo (int) $mag['id']; ?>">Delete</a>
									</font></td>
								</tr>
<?php endforeach; ?>
							</table>
