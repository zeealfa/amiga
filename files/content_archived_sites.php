<table width=100% align=center cellpadding=0>
	<tr>
		<td>
			<title>AmigaSource.com - ARCHIVED SITES</title>
...
$where = "links_archived_url IS NOT NULL AND links_archived_url<>''";
...
<?php
$stmt = mysqli_prepare($myConnection, "SELECT * FROM t_links WHERE $where ORDER BY links_archived_date DESC LIMIT ?, ?");
